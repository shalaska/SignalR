...
namespace Microsoft.AspNet.SignalR.Client.Tests
{
    public class TransportFacts
    {
        ...
        public void CancelledTaskHandledWhenStartingLongPolling()
        {
            ...
            Assert.Equal(Resources.Error_ConnectionCancelled, unwrappedException.Message);
        }
            ...
            Mock.Get(longPollingTransport)
                .Verify(
                    t => t.OnError(It.IsAny<IConnection>(),
                            It.Is<OperationCanceledException>(e => e.Message == Resources.Error_TaskCancelledException)),
                    Times.Once());
        }
